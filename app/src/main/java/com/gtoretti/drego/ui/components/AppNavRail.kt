...
package com.gtoretti.drego.ui.components
...
import com.gtoretti.drego.ui.JetnewsDestinations
...
fun AppNavRail(currentRoute: String, navigateToHome: () -> Unit, navigateToAccountingAccounts: () -> Unit,navigateToBalanceSheet: () -> Unit,navigateToAssetEvolution: () -> Unit,modifier: Modifier = Modifier) {
    NavigationRail(
        ...
        NavigationRailItem(
            selected = currentRoute == JetnewsDestinations.HOME,
        ...
        NavigationRailItem(
            selected = currentRoute == JetnewsDestinations.CASH_FLOWS_STATEMENT,
            onClick = navigateToAccountingAccounts,
        ...
        NavigationRailItem(
            selected = currentRoute == JetnewsDestinations.PERIOD_RESULTS_STATEMENT,
            onClick = navigateToAccountingAccounts,
...
fun PreviewAppNavRail() {
    JetnewsTheme {
        AppNavRail(
            currentRoute = JetnewsDestinations.ACCOUNTING_ACCOUNTS,
            navigateToHome = {},
