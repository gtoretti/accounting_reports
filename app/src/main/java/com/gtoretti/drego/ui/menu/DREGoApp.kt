...
@Composable
fun DREGoApp(appContainer: AppContainer, widthSizeClass: WindowWidthSizeClass) {
    DREGoTheme {
        val navController = rememberNavController()
        val navigationActions = remember(navController) {
            DREGoNavigationActions(navController)
        }
        ...
        val currentRoute =
            navBackStackEntry?.destination?.route ?: DREGoDestinations.HOME
        ...
        ModalNavigationDrawer(
            drawerContent = {
                AppDrawer(
                    ...
                    navigationActions.navigateToBalanceSheet,
                    navigationActions.navigateToEquityChangesStatement,
