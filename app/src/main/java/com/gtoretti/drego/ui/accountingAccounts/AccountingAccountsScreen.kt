...
package com.gtoretti.drego.ui.accountingAccounts
...
import com.gtoretti.drego.ui.utils.showExpandCollapseButton
import com.gtoretti.drego.ui.utils.switchState
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_ALL

import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL1_ATIVO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL1_PASSIVO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL2_ATIVO_CIRCULANTE
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL2_ATIVO_NAO_CIRCULANTE
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL2_PASSIVO_CIRCULANTE
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL2_PASSIVO_NAO_CIRCULANTE
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL2_PASSIVO_PATRIMONIO_LIQUIDO


import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_CIRCULANTE_CAIXA_E_EQUIVALENTES_DE_CAIXA
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_CIRCULANTE_CONTAS_A_RECEBER
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_CIRCULANTE_DESPESAS_ANTECIPADAS
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_CIRCULANTE_ESTOQUES
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_NAO_CIRCULANTE_ATIVOS_INTANGIVEIS
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_NAO_CIRCULANTE_ATIVOS_REALIZAVEIS_A_LONGO_PRAZO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_NAO_CIRCULANTE_IMOBILIZADO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_ATIVO_NAO_CIRCULANTE_INVESTIMENTOS_DE_LONGO_PRAZO


import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_CIRCULANTE_FINANCEIRO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_CIRCULANTE_OPERACIONAL
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_NAO_CIRCULANTE_ARRENDAMENTO_MERCANTIL_FINANCEIRO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_NAO_CIRCULANTE_DEBENTURES
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_NAO_CIRCULANTE_EMPRESTIMOS_E_FINANCIAMENTOS_DE_LONGO_PRAZO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_NAO_CIRCULANTE_OBRIGACOES_FISCAIS_E_TRABALHISTAS_DE_LONGO_PRAZO
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PASSIVO_NAO_CIRCULANTE_PROVISOES_PARA_CONTINGENCIAS

import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_ACOES_EM_TESOURARIA
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_AJUSTES_DE_AVALIACAO_PATRIMONIAL
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_CAPITAL_SOCIAL
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_PREJUIZOS_ACUMULADOS
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_RESERVAS_DE_CAPITAL
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_LEVEL3_PATRIMONIO_LIQUIDO_RESERVAS_DE_LUCROS
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_TYPE_ASSET
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_TYPE_RESULT
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_TYPE_RESULT_LEVEL1_FINANCING
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_TYPE_RESULT_LEVEL1_INVESTING
import com.gtoretti.drego.utils.ACCOUNTING_ACCOUNTS_TYPE_RESULT_LEVEL1_OPERATING
