...
fun DREGoAppNavGraph(
    ...
    NavHost(
        ...
        composable(DREGoDestinations.ACCOUNTING_ACCOUNTS) {
        ...
        composable(DREGoDestinations.BALANCE_SHEET) {
        ...
        composable(DREGoDestinations.EQUITY_CHANGES_STATEMENT) {
        ...
        composable(DREGoDestinations.EXPLANATORY_NOTES) {
        ...
        composable(DREGoDestinations.CASH_FLOWS_STATEMENT) {
        ...
        composable(DREGoDestinations.PERIOD_RESULTS_STATEMENT) {
